        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                <div class="card mb-5 shadow-sm border">
                    <div class="card-body">
                        <form class="p-4" action="/admin/event/" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label" for="title">Title</label>
                                    <input class="form-control form-control-sm" type="text" name="title" id="title" autofocus required>
                                    <input class="form-control form-control-sm" type="text" name="slug" id="slug" hidden>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label" for="venue">Venue</label>
                                    <input class="form-control form-control-sm" type="text" name="venue" id="venue">
                                </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input class="form-control form-control-sm" type="date" id="date" name="date" onchange="previewImage">
                                </div>
                                <div class="col-lg-6 mb-3">
