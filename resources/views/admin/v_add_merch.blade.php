        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                <div class="card mb-5 shadow-sm border">
                    <div class="card-body">
                        <form class="p-4" action="/admin/merch/" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-2">
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input class="form-control form-control-sm" type="text" name="price" id="price" placeholder="Example: 150000" value="<?= old('price'); ?>">
                                </div>
