        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                <div class="card mb-5 shadow-sm border">
                    <div class="card-body">
                        <form class="p-4" action="/admin/merch/<?= $merch->slug; ?>/update" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-2">
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input class="form-control form-control-sm" type="text" name="title" id="title" value="<?= old('title', $merch->title); ?>">
                                    <input class="form-control form-control-sm" type="text" name="slug" id="slug" value="<?= old('slug', $merch->slug); ?>" hidden>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label" for="price">Price (Rp)</label>
                                    <input class="form-control form-control-sm" type="text" name="price" id="price" placeholder="Example: 150000" value="<?= old('price', $merch->price); ?>">
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label" for="desc">Description</label>
                                    <form …>
                                        <input class="@error('desc')is-invalid @enderror" id="desc" type="hidden" name="desc" value="<?= old('desc', $merch->desc); ?>">
