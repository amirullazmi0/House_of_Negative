        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="pop mb-3 shadow-sm border">
                    <h1 class="text-center">EDIT MERCH</h1>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="card mb-5 shadow-sm border">
                    <div class="card-body">
                        <form class="p-4" action="/admin/news/<?= $news->slug; ?>/update
                        " enctype="multipart/form-data" method="post">
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input class="form-control form-control-sm" type="text" name="title" id="title" value="<?= old('title', $news->title); ?>">
                                    <input class="form-control form-control-sm" type="text" name="slug" id="slug" value="<?= old('slug', $news->slug); ?>" hidden>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label" for="desc">Description</label>
                                    <form …>
                                        <input class="@error('desc')is-invalid @enderror" id="desc" type="hidden" name="desc" value="<?= old('desc', $news->desc); ?>">
